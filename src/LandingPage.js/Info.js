const Info = () => {
  return (
    <>
      ...
      <br></br>
      <p>
        I am bit of a nerd, so in my free time I enjoy playing dungeons &
        dragons, boardgames and magic the gathering. I also enjoy playing
        videogames such as Zelda: breath of the wild, Witcher 3 and Overwatch.
      </p>
    </>
  );
};
